...
<em align="center">Using the desired model, we solve for the turbulence and magnetic fields. Five additional parameters are introduced. For the equations mentioned in this flowchart, kindle refer to the manuscript.</em>
</p>
